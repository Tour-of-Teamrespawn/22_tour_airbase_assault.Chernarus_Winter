...
if (count TOUR_barrackSpawnSpare2 == 0) exitWith {};
...
{
	_number = TOUR_barrackSpawnSpare2 call BIS_fnc_selectRandom;
	TOUR_barrackSpawnSpare2 = TOUR_barrackSpawnSpare2 - [_number];
};
...
{
	_pos = getMarkerPos format ["TOUR_mkr_guard_%1", _number + 7];
};
