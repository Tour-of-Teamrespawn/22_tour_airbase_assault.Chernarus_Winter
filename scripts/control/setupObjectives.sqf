[WEST, "TOUR_objAirstrip", ["Assist the British paratroopers in securing <marker name=""TOUR_mkr_objAirstrip"">Olsha Airstrip</marker>, by eliminating enemy forces and armored targets, in the immediate area.", "Capture Airstrip", "TOUR_mkr_objAirstrip"],  objNull, "ASSIGNED", -1, false, ""] call BIS_fnc_taskCreate;
[WEST, "TOUR_objComms", ["Destroy the <marker name=""TOUR_mkr_objComms"">Communication Tower</marker> to prevent distress calls.", "Disrupt Communications", "TOUR_mkr_objComms"],  objNull, "CREATED", -1, false, ""] call BIS_fnc_taskCreate;
[WEST, "TOUR_objZU23", ["Disable the ZU-23 to help the airborne troops to begin the assault.", "Disable ZU-23", "TOUR_mkr_objAirstrip"],  objNull, "CREATED", -1, false, ""] call BIS_fnc_taskCreate;
[WEST, "TOUR_objReturn", ["Leave the area in a helicopter to move back to <marker name=""TOUR_mkr_objReturn"">HMS Queen Elizabeth</marker>. Make sure you have smokes, and are away from the enemy. The evac choppers will fly in from the east.", "Return To Ship", "TOUR_mkr_objReturn"],  objNull, "CREATED", -1, false, ""] call BIS_fnc_taskCreate;
